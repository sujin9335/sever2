...
<body>
	...
	<table class="vertical">
		<tr>
			<th>너비(px)</th>
			<td><input type="number" name="width" min="50" max="300" step="10" value="50"></td>
		</tr>
		<tr>
			<th>높이(px)</th>
			<td><input type="number" name="hight" min="50" max="300" step="10" value="50"></td>
		</tr>
		<tr>
			<th>텍스트</th>
		...
		<tr>
			<th>버튼 개수(ea)</th>
			<td><input type="number" name="ea" min="1" max="10" value="1"></td>
		</tr>
		<tr>
			<th></th>
			<td></td>
