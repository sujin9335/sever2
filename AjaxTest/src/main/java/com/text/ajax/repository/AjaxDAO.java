...
public class AjaxDAO {
	...
	public ArrayList<AddressDTO> listAddress() {
		try {
			...
			String sql="select seq, name, age, gender, address, "
					+ "to_char(regdate, 'yyyy-mm-dd') as regdate from tblAddress order by seq desc";
	...
	public int delAdderss(String seq) {
		...
		try {
			...
			System.out.println("AjaxDAO.delAdderss");
			e.printStackTrace();
		}
